...
from helpers import validate_booking_data, generate_booking_reference
...
def create_booking():
    ...
    try:
        ...
        if db.create_booking(booking_data):
            ...
            # SNS notification disabled for local testing.
            # Enable this when AWS credentials are configured.
